Blogging application created while taking Udemy PHP course. The application has its administrator panel with the implementation of CRUD operations on posts, comments, and users. 
